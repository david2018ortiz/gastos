...
export function IconPicker({ defaultValue }: { defaultValue?: string | null }) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-8 gap-1.5 max-h-72 overflow-y-auto rounded-xl border p-2">
        {ICONS.map((icon) => (
          <button
            key={icon}
            type="button"
            ...
            className={
              "flex h-8 w-8 items-center justify-center rounded-full text-base transition-transform active:scale-90 " +
              (icon === selected
